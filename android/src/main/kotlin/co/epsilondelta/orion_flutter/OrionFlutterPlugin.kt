...
class OrionFlutterPlugin : FlutterPlugin, MethodCallHandler {
    ...
    override fun onAttachedToEngine(@NonNull binding: FlutterPlugin.FlutterPluginBinding) {
        ...
        if (appContext is Application) {
            ...
            Log.e("OrionDartPlugin", "⚠️ Unable to cast context to Application")
        }
        Log.d("OrionDartPlugin", "Plugin attached")
    ...
    override fun onMethodCall(@NonNull call: MethodCall, @NonNull result: Result) {
        when (call.method) {
            ...
            "initializeEdOrion" -> {
                try {
                    ...
                    edOrionInstance?.startListening()
                        ...
                        Log.d("OrionDartPlugin", "Orion initialized via Dart")
                        result.success("orion_initialized")
                } catch (e: Exception) {
                    Log.e("OrionDartPlugin", "⚠️ binding.applicationContext is not an Application")
            ...
            "getRuntimeMetrics" -> {
                Log.d("OrionDartPlugin", "Returning Orion runtime metrics")
            ...
            "trackFlutterScreen" -> {
                try {
                    ...
                    Log.d("OrionDartPlugin", "Received screen = $screenName")
                    Log.d("OrionDartPlugin", "runtimeMetricsJson payload = $runtimeMetricsJson")
            ...
            "trackFlutterError" -> {
                try {
                    ...
                    val screenName = call.argument<String>("screen") ?: "UnknownScreen3"
